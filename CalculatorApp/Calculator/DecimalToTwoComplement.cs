    ...
    public class DecimalToTwoComplement : Conversion
    {
        ...
        public override string Change(string input)
        {
            ...
            if (number < minVal || number > maxVal)
                ...
                /* 1. Converts the decimal (signed) number into an unsigned integer, removing any negative sign and making it non-negative
                
                2. Shifts the binary value 1 left by size bits, effectively creating a number that represents 2^size
                
                3. Substracts 1 from the shifted value, creatiing a mask with all bits set to 1 up to the size bit, and 0 beyond that. */
                ...
                2. Pads the resulting binary string to the left with 0 characters, ensuring that the string has exactly size bits.
                */
